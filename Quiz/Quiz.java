...
public class Quiz extends JFrame implements ActionListener
{
	...
	Quiz(String name)
	{
		...
		add(question);
		questions[0][0] = "Who is invented java language  .?";
        questions[0][1] = "guido van rossum";
        questions[0][2] = "James ghosling";
        questions[0][3] = "Dennis ritche";
        ...
        next.setBackground(new Color(231,84,128));
        ...
        Lifeline.setBackground(new Color(231,84,128));
        ...
        submit.setBackground(new Color(231,84,128));
